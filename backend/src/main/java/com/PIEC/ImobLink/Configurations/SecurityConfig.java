    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/images/**").hasAnyAuthority("USER", "ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/posts/**").hasAnyAuthority("USER", "ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/comments/**").hasAnyAuthority("USER", "ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/follow/**").hasAnyAuthority("USER", "ADMIN", "SUPER_ADMIN")
